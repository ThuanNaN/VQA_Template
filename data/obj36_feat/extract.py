...
def load_image_ids(img_root, split_dir= None):
...
def parse_args():
    ...
    parser.add_argument('--ds_name', type=str, default='vivqa')
...
if __name__ == '__main__':
    ...
    if args.split is not None:
        args.outfile = "%s_%s_obj36.tsv" % (args.ds_name, args.split)
    else:
        args.outfile = "%s_obj36.tsv" % args.ds_name
