...
train_csv_path = "../data/vivqa/train.csv"
...
if __name__ == "__main__":
    ...
    train_image_paths = get_image_paths(train_image_ids)
    test_image_paths = get_image_paths(test_image_ids)

    image_dir = "../data/vivqa/images"
    os.makedirs(image_dir, exist_ok=True)
    copy_to_vivqa_dir(train_image_paths, image_dir)
