"""
Example usage of ViOCRVQA Dataset

This script demonstrates how to use the ViOCRVQA dataset loader.
ViOCRVQA is a Vietnamese OCR-based Visual Question Answering dataset.
"""

import sys
sys.path.append('..')

from dataset import ViOCRVQADataset
...
def main():
    ...
    train_dataset = ViOCRVQADataset(
        ...
        img_dir="data/viocrvqa/images",  # ViOCRVQA images directory
    ...
    # Development set
    dev_dataset = ViOCRVQADataset(
        ann_path="data/viocrvqa/dev.json",
    ...
    print("="*50)
    import json
    with open("data/viocrvqa/train.json", 'r', encoding='utf-8') as f:
    ...
    print("\nNote: ViOCRVQA focuses on OCR-based questions where text recognition")
    print("from images is crucial for answering questions.")
