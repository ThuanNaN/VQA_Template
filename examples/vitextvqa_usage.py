"""
Example usage of ViTextVQA Dataset

This script demonstrates how to use the ViTextVQA dataset loader.
ViTextVQA is a Vietnamese Text-based Visual Question Answering dataset
that focuses on reading and understanding text in images.
"""

import sys
sys.path.append('..')

from dataset import ViTextVQADataset
...
def main():
    ...
    print("Loading ViTextVQA dataset...")
    
    # Training set
    train_dataset = ViTextVQADataset(
        ann_path="data/vitextvqa/ViTextVQA_train.json",
        img_dir="data/vitextvqa/images",  # ViTextVQA images directory
    ...
    # Development set
    dev_dataset = ViTextVQADataset(
        ann_path="data/vitextvqa/ViTextVQA_dev.json",
    ...
    # Test set
    test_dataset = ViTextVQADataset(
        ann_path="data/vitextvqa/ViTextVQA_test.json",
        img_dir="data/vitextvqa/images",
        text_processor=text_processor,
        vis_processor=vis_processor,
        max_length=128
    ...
    print("\nNote: ViTextVQA focuses on text-based questions where reading and")
    print("understanding text in images is essential for answering questions.")
    print("This is particularly useful for Vietnamese scene text understanding.")
